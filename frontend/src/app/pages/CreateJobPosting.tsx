...
import { ArrowLeft, Briefcase, MapPin, DollarSign, Clock, Building2, GraduationCap, Sparkles, FileText, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form id="job-posting-form" onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* AI Optimization Tip */}
          <Card className="rounded-3xl border-2 bg-gradient-to-br from-[#fd7e14]/5 to-[#28a745]/5">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#fd7e14] to-[#28a745] flex items-center justify-center flex-shrink-0">
                  <Sparkles className="w-6 h-6 text-white" />
                </div>
                <div className="space-y-2">
                  <h3 className="font-semibold text-[#003366]">Optimización con IA</h3>
                  <p className="text-sm text-gray-600">
                    Nuestro sistema de matching inteligente analizará tu vacante y la conectará automáticamente con los candidatos más adecuados de Universidad de Guadalajara. Asegúrate de incluir detalles específicos sobre habilidades y requisitos para obtener mejores matches.
                  </p>
                </div>
              </div>
            </CardContent>
